...
#define __PYX_HAVE__spacy__typedefs
#define __PYX_HAVE_API__spacy__typedefs
#include <stdint.h>
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
#define __Pyx_MODULE_NAME "spacy.typedefs"
int __pyx_module_is_main_spacy__typedefs = 0;

/* Implementation of 'spacy.typedefs' */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_spacy__typedefs) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "spacy.typedefs")) {
      if (unlikely(PyDict_SetItemString(modules, "spacy.typedefs", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init spacy.typedefs", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init spacy.typedefs");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
